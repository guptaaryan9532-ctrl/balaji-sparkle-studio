// Image-free source of truth for all Balaji Graphics content.
// Safe to import from anywhere (including the MCP server bundle).
...
export const EMAIL = "sbjprintingpress32@gmail.com";
export const LOCATION = "Kanpur, India";
export const WEBSITE_URL = "https://balajigraphics.lovable.app";
...
export const serviceCatalog: ServiceInfo[] = [
  {
    ...
    description:
      "Get a professional, unique logo that represents your brand perfectly. Our designers create memorable logos that make lasting impressions on your customers.",
    icon: "Palette",
    pricing: [
  ...
  },
  {
    ...
    description:
      "Stunning poster designs for events, promotions, festivals, and more. We create vibrant, attention-grabbing posters that communicate your message effectively.",
    icon: "Image",
    pricing: [
  ...
  },
  {
    ...
    description:
      "Professional banner and flex designs for shops, events, and outdoor advertising. High-impact designs that grab attention from a distance.",
    icon: "Monitor",
    pricing: [
  ...
  },
  {
    ...
    description:
      "Professional social media post designs for Instagram, Facebook, WhatsApp, and more. Boost your online presence with stunning visuals.",
    icon: "Share2",
    pricing: [
  ...
  },
  {
    ...
    description:
      "Elegant and traditional wedding card designs that perfectly capture the joy of your special occasion. Both modern and traditional Indian styles available.",
    icon: "Heart",
    pricing: [
  ...
  },
  {
    ...
    description:
      "Make a great first impression with professionally designed visiting cards. Modern, clean, and memorable designs for your business.",
    icon: "CreditCard",
    pricing: [
  ...
  },
  {
    ...
    description:
      "Complete promotional graphics package including flyers, brochures, standees, and marketing collateral designed to boost your business.",
    icon: "Megaphone",
    pricing: [
...
export const portfolioCatalog: PortfolioInfo[] = [
