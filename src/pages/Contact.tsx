          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-3">
                ...
                <a href="mailto:balajigraphics@gmail.com" className="flex items-center gap-3 text-muted-foreground hover:text-foreground">
                  <Mail className="w-5 h-5 text-primary" /> balajigraphics@gmail.com
                </a>
